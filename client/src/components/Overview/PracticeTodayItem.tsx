...
const PracticeTodayItem = ({ test }: Props) => {
	const navigate = useNavigate();

	return (
		<div
			className="flex justify-between gap-2 p-5 bg-blue-500 rounded-sm cursor-pointer dark:bg-blue-600 hover:bg-blue-600 dark:hover:bg-blue-700"
